...
fn non_minimal_scriptints() {
    ...
    assert_eq!(read_scriptint(&[0x8f, 0x00, 0x00]).unwrap_err(), crate::blockdata::script::ScriptIntError::NonMinimalPush);
    assert_eq!(read_scriptint(&[0x7f, 0x00]).unwrap_err(), crate::blockdata::script::ScriptIntError::NonMinimalPush);
